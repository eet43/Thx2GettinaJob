...
public class ExamDdayTimeInfo implements Serializable {
    ...
    public static ExamDdayTimeInfo fromEntity(ExamTimeStamp timeStamp, String status, Long day) {
        return new ExamDdayTimeInfo(timeStamp.getId(), timeStamp.getTurn(), timeStamp.getExamDate(), timeStamp.getRegStartDate(), timeStamp.getRegEndDate(),
